...
2. O segundo experimento foi para ampliar o circuito, adicionando mais cinco sensores ópticos e mais cinco *LEDs* (Figura \ref{circuito_bb}):\
...
O prototipo pode ser observado nas figuras \ref{est_ort}, \ref{est_dir} e \ref{est_top}.\


![Prototipo vista ortogonal.\label{est_ort}](./RMarkdown/Imagens/Estrutura_ortogonal.jpeg){width=30%}



![Prototipo vista da lateral direita.\label{est_dir}](./RMarkdown/Imagens/Estrutura_vist_dir.jpeg){width=30%}



![Prototipo vista superior.\label{est_top}](./RMarkdown/Imagens/Estrutura_vist_top.jpeg){width=30%}
