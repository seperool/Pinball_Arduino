...
![Placa da estrutura com furos para encaixe dos dispositivos. \label{placa_est}](./RMarkdown/Imagens/estrutura_aberturas.jpeg){width=30%}

- Os sensores, Arduino e placa de *LCD* foram presos a estrutura do pinball por cola quente. (Figura \ref{montagem_disp})\


![Montagem dos dispositivos eletrônicos na estrutura do pinball. \label{montagem_disp}](./RMarkdown/Imagens/montagem_bb.jpeg){width=30%}


- Os fios e dispositivos eletrônicos foram soldados uns aos outros. (Figura \ref{fios})\


![Fios soldados e presos na estrutura do pinball. \label{fios}](./RMarkdown/Imagens/montagem.jpeg){width=30%}
